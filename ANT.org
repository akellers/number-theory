...
- /Gauss/ (1777 - 1855): Fand den ersten Beweis des quadratischen
  ...
  finden. Er studierte die Klassifikation binärer quadratsicher Formen
  über $\mathbb{Z}$, die eng verbunden ist mit der Frage nach der
  Klassenzahl quadratischer Zahlkörper.
- /Dirichlet/ (1805 - 1859): Führte $L$ Reihen ein und bewies mit
  ...
  irredzubiblen Polynoms $f(x)$ mit ganzzahligen
