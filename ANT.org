...
* TODO Einführung
  ...
  \begin{equation*}
    m = \pm p_1 \cdots p_n, \quad p_i \quad \text{Primzahlen,}
  \end{equation*}
  ...
  und wenn gilt:
  \begin{equation*}
    \pi | ab \Rightarrow \pi | a \quad \text{oder} \quad \pi | b.
  \end{equation*}

  Ist $A$ ein Hauptidealring, kann jedes Element $a$ von $A$ ungleich 0
  geschrieben werden als
  \begin{equation*}
    a = u \pi_1 \cdots \pi_{n}, \qquad u \quad \text{Einheit und}
        \quad \pi_{i} \quad \text{Primelementen}
  \end{equation*}
