...
** Faktorisierung
   ...
   Es bleibt die Frage, wie weit dies entferent ist von einer eindeutigen Faktorisierung? Anders
   formuliert: Wie viele "ideale" Elemente müssen zu den "wirklichen" Elementen hinzunehmen, um eine
   eindeutige Faktorisierung zu erreichen. In einen bestimmten Sinn: Nur endlich viele: Eine
   endliche Menge $S$ von solchen Idealen ist ausreichend, um jedes Ideal darzustellen als
